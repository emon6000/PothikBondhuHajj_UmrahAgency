      ...
      <div className="footer-container">
        ...
        <div className="footer-col brand-col">
          ...
          <div className="contact-line">
            ...
            <span>32 Purana Paltan, Sultan Ahmed Plaza<br/>11th Floor, Suite-1202, Dhaka-1000</span>
          </div>
          <div className="contact-line">
        ...
        <div className="footer-col links-col">
          ...
          <ul>
            <li><Link to="/packages?type=umrah">Umrah Package</Link></li>
            <li><Link to="/packages?type=hajj">Hajj Package</Link></li>
            <li><Link to="/terms">Terms & Conditions</Link></li>
            <li><Link to="/privacy">Privacy Policy</Link></li>
            <li><Link to="/about">About Us</Link></li>
            <li><Link to="/training">Hajj Training</Link></li>
        ...
        <div className="footer-col links-col">
          ...
          <ul>
            <li><a href="#">Bangladesh Hajj Portal</a></li>
            <li><a href="#">Civil Aviation Authority</a></li>
            <li><a href="#">ATAB</a></li>
            <li><a href="#">HAAB</a></li>
            <li><a href="#">Ministry of Hajj, KSA</a></li>
            <li><a href="#">NUSUK</a></li>
            <li><a href="#">Hajj & Umrah Visa Check</a></li>
            <li><a href="#">Corporate IT Support</a></li>
          </ul>
        </div>
        ...
        <div className="footer-col offices-col">
          ...
          <div className="office-card">
            ...
            <p>Al Maarefa Road, North Al<br/>Aziziyah, Makkah</p>
          ...
          <div className="office-card">
            ...
            <p>University Road, Kotbari<br/>Comilla, Bangladesh</p>
            <div className="office-phone">
