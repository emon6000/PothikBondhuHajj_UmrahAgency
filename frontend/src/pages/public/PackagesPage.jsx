  ...
  return (
    <div className="packages-explorer-page">
      <div className="explorer-header">
        ...
        <p>Browse our meticulously planned itineraries tailored for your comfort and peace of mind.</p>
      </div>

      <div className="explorer-filters">
        <button className={`filter-btn ${activeFilter === 'all' ? 'active' : ''}`} onClick={() => setActiveFilter('all')}>View All</button>
        <button className={`filter-btn ${activeFilter === 'hajj' ? 'active' : ''}`} onClick={() => setActiveFilter('hajj')}>Hajj Only</button>
        <button className={`filter-btn ${activeFilter === 'umrah' ? 'active' : ''}`} onClick={() => setActiveFilter('umrah')}>Umrah Only</button>
      </div>
            ...
            <div className="explorer-card fade-in" key={pkg.id}>
              ...
              <div className="card-content">
                ...
                <div className="pkg-details-list">
                  <p><FaClock className="detail-icon" /> <strong>Duration:</strong> {pkg.duration}</p>
                  <p>
                  ...
                  <p><FaCalendarAlt className="detail-icon" /> <strong>Availability:</strong> Open for Booking</p>
                </div>
                <div className="card-actions">
                  <Link to={`/packages/${pkg.id}`} className="secondary-btn">View Itinerary</Link>
                  <Link to="/register" state={{ selectedPackageId: pkg.id }} className="primary-btn">Book Now</Link>
                </div>
              </div>
            </div>
          ))
