  ...
  return (
    <div className="packages-explorer-page">
      ...
      <div className="explorer-header">
        <h2>
          {activeFilter === 'hajj' ? 'Exclusive Hajj Packages' : 
           activeFilter === 'umrah' ? 'Premium Umrah Packages' : 
            ...
            <div className="explorer-card fade-in" key={pkg.id}>
              ...
              <div className="card-content">
                ...
                <div className="pkg-details-list">
                  ...
                  <p><FaMoneyBillWave className="detail-icon" /> <strong>Price:</strong> <span className="price-text">{pkg.price}</span></p>
                ...
                <div className="card-actions">
                  ...
                  <Link to="/hajj/pre-registration" className="primary-btn">
                    Book Now
                  </Link>
                </div>
              </div>
