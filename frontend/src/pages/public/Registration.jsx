  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (user) {
        ...
        if (response.ok) {
          alert(
            `Success! Application submitted. We will contact you with your Tracking ID shortly.`
          );
          navigate('/');
        } else {
      ...
      <div className="pkg-selection-grid">
        {filteredPackages.map((pkg) => (
          <div
            ...
            style={{
              border: selectedPkg?.id === pkg.id ? '2px solid #064e3b' : '1px solid #eee',
              cursor: 'pointer',
              padding: '1rem',
              borderRadius: '8px',
            }}
        ...
        <div className="reg-form-container" style={{ marginTop: '2rem' }}>
          {user ? (
            ...
            >
              ...
              <p>
                Registering for: <strong>{selectedPkg.title}</strong>
              </p>
            ...
            <form
              ...
              style={{ background: '#f8fafc', padding: '2rem', borderRadius: '10px' }}
            >
              <h3
                style={{
                  marginBottom: '1.5rem',
              ...
              <div className="input-group" style={{ marginBottom: '20px' }}>
                <label>
                  <FaEnvelope /> Email Address (For Notifications)
                </label>
                <input
                  type="email"
                  name="email"
